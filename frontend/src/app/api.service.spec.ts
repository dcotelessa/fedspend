...
describe('ApiService', () => {
  ...
  const testTable: TestCase[] = [
    ...
    },
    {
      ...
      args: [1],
      expectedUrl: 'http://localhost:3000/api/agencies/1/spotlight',
    ...
    },
    {
      ...
      args: [1],
      expectedUrl: 'http://localhost:3000/api/agencies/1/summary',
    ...
    },
    {
      ...
      expectedUrl: 'http://localhost:3000/api/geography/states?fiscalYear=2024&agencyId=1',
    ...
    },
    {
      ...
      args: ['06'],
      expectedUrl: 'http://localhost:3000/api/geography/state/06',
    ...
    },
    {
      ...
      args: [],
      expectedUrl: 'http://localhost:3000/api/disaster/overview',
    ...
    },
    {
      ...
      expectedUrl: 'http://localhost:3000/api/disaster/states?defGroup=091&fiscalYear=2024',
    ...
    },
    {
      ...
      expectedUrl: 'http://localhost:3000/api/disaster/recovery-ratios?fiscalYear=2024',
    ...
    },
    {
      ...
      args: ['06'],
      expectedUrl: 'http://localhost:3000/api/disaster/state/06',
      mockBody: { stateCode: '06', stateName: 'California', totalObligated: 100000, declarationCount: 5 },
      expected: { stateCode: '06', stateName: 'California', totalObligated: 100000, declarationCount: 5 },
    },
  ];

  it.each(testTable)('$name', ({ methodName, args, expectedUrl, mockBody, expected }) => {
    const spy = jest.fn();
